...
SELECT fk.owner, fk.constraint_name , fk.table_name
 ...
 WHERE fk.R_CONSTRAINT_NAME = pk.CONSTRAINT_NAME
   ...
   AND pk.TABLE_NAME = 'TBLMEMBER' --대문자
...
insert into tblMember (memberSeq, name, jumin, tel, email) values (3, '주형준', '434887-1779208', '061-417-4280', 'X9Nlz7hg@gmail.com');
...
insert into tblMember (memberSeq, name, jumin, tel, email) values (13, '강경연', '761248-2955570', '063-682-2422', 'OvqZL3G1@yahoo.com');
