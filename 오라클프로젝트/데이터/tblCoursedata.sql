...
insert into tblCourse values (4,'Java기반 멀티 플랫폼 응용 SW개발자 양성 과정',6,300,30);
insert into tblCourse values (5,'자바 기반 모바일 융합 SW 개발자 양성 과정',7,350,30);
insert into tblCourse values (6,'Framework 기반의 빅데이터 활용 응용프로그래머 양성과정',7,450,30);


insert into tblCourse values (7,'웹기반 빅데이터 분석 응용SW개발자 양성과정',5.5,400,26);
insert into tblCourse values (8,'Java를 활용한 웹 응용SW개발자 양성과정',5.5,300,26);
insert into tblCourse values (9,'JAVA기반 Web Platform Service 구축 Web,App 개발자 양성과정',6,400,26);
